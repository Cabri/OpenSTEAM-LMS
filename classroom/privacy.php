...
<body>
    ...
    <script src="assets/js/lib/jquery-i18next.min.js?version=1.1"></script>
    <script src="assets/js/lib/i18nextXHRBackend.min.js?version=1.1"></script>
    <script src="assets/js/lib/i18nextBrowserLanguageDetector.min.js?version=1.1"></script>
    <script src="assets/js/utils/translate.js?version=1.1"></script>

    <!-- <script src="/interfaces/assets/js/main/modal.js?version=1.1" defer></script> -->
</body>
