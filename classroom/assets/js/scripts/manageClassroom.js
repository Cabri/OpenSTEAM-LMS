                ...
                <th data-toggle="tooltip" data-placement="top" title="${ arrayIndexesActivities[i].title }">
                    <div class="dropdown dropdown-act" style="width:30px;">
                        <div id="dropdown-act-${activityNumber}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            class="classroom-clickable col-12 dropdown-item" onclick="activityModify(${arrayIndexesActivities[i].id})"><i class="fas fa-pen"></i> <span data-i18n="classroom.classes.panel.editActivity">Modifier l'activité</span></li>
...
function addStudentRow(pseudo) {
    ...
    <li class="row align-items-center my-1 ">
        <img class="col-2 propic" src="${_PATH}assets/media/alphabet/` + pseudo.slice(0, 1).toUpperCase() + `.png?version=1.1" alt="Photo de profil">
